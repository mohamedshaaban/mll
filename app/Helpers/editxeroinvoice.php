...
if ( ! function_exists( 'editxeroinvoice' ) ) {
/**
...
*/
function editxeroinvoice( $data ,$isOrder) {
generatexerotoken();
$lineItems = [] ;
...
$account = isset($driver)? $driver->xero_revenue_account : null ;
if(!$account)
{
